...
class __TwigTemplate_2f2c35cb184ae93c725644ccbc14b7dad16385b65528f98b04bcc1f34903baab extends Twig_Template
{
...
<div class=\"col\">
    <div class=\"card\" id=\"configuration_fieldset_order_by_pagination\">
        ...
        echo "
                    ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "products_per_page", array()), 'errors');
        echo "
                    ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "products_per_page", array()), 'widget');
        echo "
                </div>
                <div class=\"form-group\">
                    ";
        ...
        echo "
                    ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "default_order_by", array()), 'errors');
        echo "
                    ";
        // line 43
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "default_order_by", array()), 'widget');
        echo "
                </div>
                <div class=\"form-group\">
                    ";
        ...
        echo "
                    ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "default_order_way", array()), 'errors');
        echo "
                    ";
        // line 48
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["paginationForm"]) ? $context["paginationForm"] : null), "default_order_way", array()), 'widget');
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Configure/ShopParameters/Blocks:product_preferences_pagination.html.twig", "C:\\xampp\\htdocs\\prestashop\\src\\PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/Blocks/product_preferences_pagination.html.twig");
    }
}
