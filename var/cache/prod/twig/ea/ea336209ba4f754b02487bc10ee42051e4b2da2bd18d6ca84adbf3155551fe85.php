...
class __TwigTemplate_8add1e87e32c3142242cf3ddbabdc545dbd4ce090cf566dda9666223bc6e1407 extends Twig_Template
{
...
<div class=\"col\">
    <div class=\"card\" id=\"configuration_fieldset_stock\">
        ...
        echo "
                ";
        // line 36
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "allow_ordering_oos", array()), 'errors');
        echo "
                ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "allow_ordering_oos", array()), 'widget');
        echo "
            </div>
            <div class=\"form-group\">
        ...
        echo "
                ...
                ";
        // line 43
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "stock_management", array()), 'errors');
        echo "
                ";
        // line 44
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "stock_management", array()), 'widget');
        echo "
            </div>
            <div class=\"form-group\">
                <label class=\"form-control-label\">
        ...
        echo "
                ";
        // line 51
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "in_stock_label", array()), 'widget');
        echo "
            </div>
            <div class=\"form-group\">
                <label class=\"form-control-label\">
        ...
        echo "
                ...
                ";
        // line 57
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_allowed_backorders", array()), 'errors');
        echo "
                ";
        // line 58
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_allowed_backorders", array()), 'widget');
        echo "
            </div>
            <div class=\"form-group\">
                <label class=\"form-control-label\">
        ...
        echo "
                ...
                ";
        // line 64
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_denied_backorders", array()), 'errors');
        echo "
                ";
        // line 65
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_denied_backorders", array()), 'widget');
        echo "
            </div>
            <div class=\"form-group\">
                ";
        ...
        echo "
                ";
        // line 69
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "delivery_time", array()), 'errors');
        echo "
                ";
        // line 70
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "delivery_time", array()), 'widget');
        echo "
        ...
        echo "
                ";
        // line 75
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_delivery_time", array()), 'errors');
        echo "
                ";
        // line 76
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "oos_delivery_time", array()), 'widget');
        echo "
                <small class=\"form-text\">";
        // line 77
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Leave empty to disable", array(), "Admin.Shopparameters.Feature"), "html", null, true);
        ...
        echo "
                ";
        // line 81
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "pack_stock_management", array()), 'errors');
        echo "
                ";
        // line 82
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["stockForm"]) ? $context["stockForm"] : null), "pack_stock_management", array()), 'widget');
        echo "
            </div>
        </div>
...
";
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Configure/ShopParameters/Blocks:product_preferences_stock.html.twig", "C:\\xampp\\htdocs\\prestashop\\src\\PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/Blocks/product_preferences_stock.html.twig");
    }
}
