<?php
/* Smarty version 3.1.33, created on 2018-11-30 11:23:22
  from 'C:\xampp\htdocs\prestashop\admin5957rajmy\themes\default\template\controllers\search\helpers\view\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c01720a52ec13_16782565',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4a9321086f16c523c97d1d6b2b8dc1ce8beb129d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\admin5957rajmy\\themes\\default\\template\\controllers\\search\\helpers\\view\\view.tpl',
      1 => 1542830285,
      2 => 'file',
    ),
  ),
...
function content_5c01720a52ec13_16782565 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['feature']->value) {
?>
                <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="panel">
        <h3>
            ...
            <?php } else { ?>
                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'%d orders','sprintf'=>array(count($_smarty_tpl->tpl_vars['orders']->value)),'d'=>'Admin.Navigation.Search'),$_smarty_tpl ) );?>
...
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><strong><i class="icon-external-link-sign"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['addon']->value['title'],'html','UTF-8' ));?>
</strong></a></td>
                    <td><a href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['addon']->value['href'],'html','UTF-8' ));?>
&amp;utm_source=back-office&amp;utm_medium=search&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
...
&amp;utm_source=back-office&amp;utm_medium=search&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><strong><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Show more results...','d'=>'Admin.Navigation.Search'),$_smarty_tpl ) );?>
</strong></a></td>
                </tr>
            </tfoot>
        </table>
